...
{
    [Header("References")]
    public GrapplingController grappling;
    ...
    private GrappleSpring spring; // a custom script that returns the values needed for the animation
    ...
    void DrawRope()
    {
        ...
        {
            currentGrapplePosition = grappling.GunAnchor().position;
        ...
        Vector3 gunTipPosition = grappling.GunAnchor().position;
